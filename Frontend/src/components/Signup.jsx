...
const Signup = () => {
  ...
  <div className="modal-box dark:bg-slate-900 dark:text-white border-white">
    ...
    <div className='flex justify-around mt-4'>
        ...
        <p className='text-xl'> Have acoount?{" "} <button onClick={()=>document.getElementById("my_modal_3").showModal()} className='underline text-blue-500 cursor-pointer'>Login</button> 
        <Login/>
         </p>
    </div>
    </form>
